...
let songs = [
    ...
    {songName: "Dusk till dawn", filePath: "songs/7.mp3", coverPath: "covers/7.jpg"},
    {songName: "Hymn for the weekend", filePath: "songs/8.mp3", coverPath: "covers/8.jpg"},
    {songName: "Animals", filePath: "songs/9.mp3", coverPath: "covers/9.jpg"},
    {songName: "In the end", filePath: "songs/10.mp3", coverPath: "covers/10.jpg"},
]
...
masterPlay.addEventListener('click', (e)=>{
    if(audioElement.paused || audioElement.currentTime<=0){
        ...
        gif.style.opacity = 0;
        // Array.from(document.getElementsByClassName('songItemPlay')).classList.add('fa-play-circle');
    }
})
// Listen to events
